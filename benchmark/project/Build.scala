...
object BuildSettings {
    val projectName       = "Benchmark"
    val buildOrg          = "org.kuleuven"
    val buildOrgName      = "KU Leuven, EP"
    val buildOrgURL       = "http://iiw.kuleuven.be/onderzoek/remi/ep"
    val buildDesc         = "The full benchmark created for the thesis"
...
object Dependencies {
    ...
    val myDepencencies = Seq(
        ...
        // CQRS Dependencies
        "org.scala-lang.plugins" % "continuations"     % "2.9.2", 
